...
export default class FrontDoor extends React.Component {
  ...
  render() {
    ...
    const textValue = status?"Unlock":"Lock"
    const icon = status?"lock-open":"lock"
    const statusValue = status?"Locked":"Unlocked"
    const iconStatus = status?"lock":"lock-open"
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.information}>
          ...
          <Text style={styles.tileTextName}>The front door is {statusValue}</Text>
        </TouchableOpacity>
